<section>
    ...
    <x-dialog-modal wire:model.defer='showModal'>
        ...
        <x-slot name='content'>
            <div class="text-start">
                {{-- Form --}}
                <form wire:submit.prevent="storeApresentationImageDesktop" id="store-apresentation-image-desktop-form" enctype="multipart/form-data">
                    @csrf
        ...
        <x-slot name='footer'>
            ...
            <div class="flex gap-4">
                ...
                {{-- Submit button --}}
                <x-button wire:target="storeApresentationImageDesktop" wire:loading.attr="disabled"
                          type="submit" form="store-apresentation-image-desktop-form">
                    Criar
                </x-button>
            </div>
