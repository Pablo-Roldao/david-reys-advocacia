            ...
            <div class="owl-carousel team-carousel position-relative" style="margin-top: -97px; padding: 0 30px;">
                <a href="{{route('team')}}#david-reys" class="text-decoration-none text-dark">
                    <div class="team-item text-center bg-white rounded overflow-hidden pt-4">
                        ...
                        <div class="team-img position-relative">
                            <img class="img-lawyer img-fluid" src="./img/team/david-reys.jpeg" alt="">
                        </div>
                    </div>
                </a>
                <a href="{{route('team')}}#daniel" class="text-decoration-none text-dark">
                    <div class="team-item text-center bg-white rounded overflow-hidden pt-4">
                        ...
                        <br class="lawyer-br">
                        <div class="team-img position-relative">
                            <img class="img-lawyer img-fluid" src="./img/team/" alt="Foto do Dr. Daniel">
                        </div>
                    </div>
                </a>
                <a href="{{route('team')}}#jessica-feitosa" class="text-decoration-none text-dark">
                    <div class="team-item text-center bg-white rounded overflow-hidden pt-4">
                        ...
                        <br class="lawyer-br-2">
                        <br class="lawyer-br-4">
                        <div class="team-img position-relative">
                            <img class="img-lawyer img-fluid" src="img/team/jessica-feitosa.jpeg" alt="">
                        </div>
                    </div>
                </a>
                <a href="{{route('team')}}#ana-nogueira" class="text-decoration-none text-dark">
                    <div class="team-item text-center bg-white rounded overflow-hidden pt-4">
                        ...
                        <br class="lawyer-br">
                        <div class="team-img position-relative">
                            <img class="img-lawyer img-fluid" src="img/team/ana-nogueira.jpeg" alt="">
                        </div>
                    </div>
                </a>
                <a href="{{route('team')}}#erika" class="text-decoration-none text-dark">
                    <div class="team-item text-center bg-white rounded overflow-hidden pt-4">
                        ...
                        <br class="lawyer-br">
                        <div class="team-img position-relative">
                            <img class="img-lawyer img-fluid" src="img/team/erika.jpeg" alt="">
                        </div>
                    </div>
                </a>
                <a href="{{route('team')}}#willane-reino" class="text-decoration-none text-dark">
                    <div class="team-item text-center bg-white rounded overflow-hidden pt-4">
                        ...
                        <br class="lawyer-br">
                        <div class="team-img position-relative">
                            <img class="img-lawyer img-fluid" src="img/team/willane-reino.jpeg" alt="">
                        </div>
                    </div>
                </a>
                <a href="{{route('team')}}#rossana-bion" class="text-decoration-none text-dark">
                    <div class="team-item text-center bg-white rounded overflow-hidden pt-4">
                        ...
                        <br class="lawyer-br">
                        <div class="team-img position-relative">
                            <img class="img-lawyer img-fluid" src="img/team/rossana-bion.jpeg" alt="">
                        </div>
                    </div>
                </a>
                <a href="{{route('team')}}#jhassyara-leao" class="text-decoration-none text-dark">
                    <div class="team-item text-center bg-white rounded overflow-hidden pt-4">
                        ...
                        <br class="lawyer-br">
                        <div class="team-img position-relative">
                            <img class="img-lawyer img-fluid" src="img/team/" alt="Foto da Jhassyara Leão">
                        </div>
                    </div>
                </a>
                <a href="{{route('team')}}#gilvaldo-filho" class="text-decoration-none text-dark">
                    <div class="team-item text-center bg-white rounded overflow-hidden pt-4">
                        ...
                        <br class="lawyer-br">
                        <div class="team-img position-relative">
                            <img class="img-lawyer img-fluid" src="img/team/givaldo-filho.jpeg" alt="">
                        </div>
                    </div>
                </a>
                <a href="{{route('team')}}#renata-schozen" class="text-decoration-none text-dark">
                    <div class="team-item text-center bg-white rounded overflow-hidden pt-4">
                        ...
                        <br class="lawyer-br">
                        <div class="team-img position-relative">
                            <img class="img-lawyer img-fluid" src="img/team/#" alt="Foto da Renata Souza">
                        </div>
                    </div>
                </a>
                <a href="{{route('team')}}#jackelline-cunha" class="text-decoration-none text-dark">
                    <div class="team-item text-center bg-white rounded overflow-hidden pt-4">
                        ...
                        <br class="lawyer-br-2">
                        <br class="lawyer-br-3">
                        <div class="team-img position-relative">
                            <img class="img-fluid" src="img/team/jackelline-cunha.jpeg" alt="">
                        </div>
                    </div>
                </a>
                <a href="{{route('team')}}#eduarda-souza" class="text-decoration-none text-dark">
                    <div class="team-item text-center bg-white rounded overflow-hidden pt-4">
                        ...
                        <br class="lawyer-br">
                        <div class="team-img position-relative">
                            <img class="img-lawyer img-fluid" src="img/team/eduarda-souza.jpeg" alt="">
                        </div>
                    </div>
                </a>
                <a href="{{route('team')}}#renata-ferreira" class="text-decoration-none text-dark">
                    <div class="team-item text-center bg-white rounded overflow-hidden pt-4">
                        ...
                        <br class="lawyer-br-3">
                        <div class="team-img position-relative">
                            <img class="img-lawyer img-fluid" src="img/team/renata-ferreira.png" alt="">
                        </div>
                    </div>
                </a>
                <a href="{{route('team')}}#renata-ferreira" class="text-decoration-none text-dark">
                    <div class="team-item text-center bg-white rounded overflow-hidden pt-4">
                        ...
                        <br class="lawyer-br-3">
                        <div class="team-img position-relative">
                            <img class="img-lawyer img-fluid" src="img/team/#" alt="Foto da Poliana">
                        </div>
                    </div>
                </a>
                <a href="{{route('team')}}#sarah-gomes" class="text-decoration-none text-dark">
                    <div class="team-item text-center bg-white rounded overflow-hidden pt-4">
                        ...
                        <br class="lawyer-br-4">
                        <div class="team-img position-relative">
                            <img class="img-lawyer img-fluid" src="img/team/sarah-gomes.jpeg" alt="">
                        </div>
                    </div>
                </a>
                <a href="{{route('team')}}#roseli-nascimento" class="text-decoration-none text-dark">
                    <div class="team-item text-center bg-white rounded overflow-hidden pt-4">
                        ...
                        <br class="lawyer-br-4">
                        <div class="team-img position-relative">
                            <img class="img-lawyer img-lawyer img-fluid" src="img/team/roseli-nascimento.jpeg"
                                alt="">
                        </div>
                    </div>
                </a>
                <a href="{{route('team')}}#elian-crislaine" class="text-decoration-none text-dark">
                    <div class="team-item text-center bg-white rounded overflow-hidden pt-4">
                        ...
                        <br class="lawyer-br-4">
                        <div class="team-img position-relative">
                            <img class="img-fluid" src="img/team/elian-crislaine.jpeg" alt="">
                        </div>
                    </div>
                </a>
                <a href="{{route('team')}}#florisvaldo-sampaio" class="text-decoration-none text-dark">
                    <div class="team-item text-center bg-white rounded overflow-hidden pt-4">
                        ...
                        <br class="lawyer-br-4">
                        <div class="team-img position-relative">
                            <img class="img-fluid" src="img/team/florisvaldo-sampaio.jpeg" alt="">
                        </div>
                    </div>
                </a>
            </div>
